...
export function ZoomIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...props} fill='currentColor' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
      <path d='M3 8.5A2.5 2.5 0 0 1 5.5 6h8A2.5 2.5 0 0 1 16 8.5v7A2.5 2.5 0 0 1 13.5 18h-8A2.5 2.5 0 0 1 3 15.5v-7Zm14.553 1.276A1 1 0 0 0 17 10.67v2.66a1 1 0 0 0 .553.894l3 1.5A1 1 0 0 0 22 14.83V9.17a1 1 0 0 0-1.447-.894l-3 1.5Z' />
    </svg>
  )
}
