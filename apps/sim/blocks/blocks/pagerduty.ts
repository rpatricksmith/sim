  ...
  templates: [
    {
      ...
      prompt:
        'Build a workflow triggered by a PagerDuty severity-1 incident that opens a Slack war-room channel, invites responders, posts the incident summary, and updates the channel topic with status.',
    ...
    },
    {
      ...
      prompt:
        'Create a workflow triggered when a PagerDuty incident is resolved that opens a postmortem doc with the timeline, responders, and Slack thread linked, ready for the team to fill in root cause.',
      modules: ['agent', 'workflows'],
      category: 'engineering',
      tags: ['devops', 'reporting'],
