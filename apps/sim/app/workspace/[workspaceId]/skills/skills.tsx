...
function SkillTile() {
  return (
    <div className='h-9 w-9 flex-shrink-0'>
      <div className='flex h-full w-full items-center justify-center rounded-xl border border-[var(--border-1)] bg-[var(--surface-4)] dark:bg-[var(--surface-5)]'>
        <AgentSkillsIcon className='h-5 w-5 text-[var(--text-icon)]' />
      </div>
    </div>
  )
}
